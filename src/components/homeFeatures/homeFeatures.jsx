        ...
        <div className={styles['features-component']}>
            <div className={styles['home-features-container']}>
                <div className={styles['feature']}>
                    <RiCustomerServiceLine className={styles['feature-icon']} size={46} />
                ...
                <div className={styles['feature']}>
                    <RiSecurePaymentLine className={styles['feature-icon']} size={46} />
                    <div className={styles['feature-text']}>
                        <h3>Easy Payment</h3>
                ...
                <div className={styles['feature']}>
                    <FaShippingFast className={styles['feature-icon']} size={46} />
                    <div className={styles['feature-text']}>
                        <h3>Fast Delivery</h3>
